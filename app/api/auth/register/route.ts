...
export async function POST(request: Request) {
  try {
    ...
    const newUser = {
      ...
      name,
      role: roles.includes("admin") ? "admin" : roles.includes("agronomist") ? "agronomist" : roles.includes("agri_tech") ? "agri_tech" : roles.includes("farmer") ? "farmer" : roles.includes("landowner") ? "landowner" : "investor",
      roles: roles,
      password_hash,
